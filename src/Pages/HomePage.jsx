    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <header className="w-full bg-black text-white shadow-lg fixed top-0 left-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="text-2xl font-bold tracking-wide"> <img src={Logo} className="w-42" alt="" /> </div>
          {/* Desktop Nav */}
        ...
        {/* Mobile Nav */}
        {menuOpen && (
          <nav className="md:hidden bg-black px-4 pb-4 pt-2 flex flex-col space-y-2 font-medium animate-fade-in-down">
      ...
      {/* Hero Section */}
      <section
        className="pt-24 w-full flex items-center justify-center"
        style={{
      ...
      >
        <div className="flex flex-col items-center justify-center w-full px-4 md:px-8">
          <img
            src={middleimage}
            className="w-full max-w-sm md:max-w-2xl object-contain rounded-lg shadow-lg"
            alt="Hero"
          />
        </div>
      </section>
